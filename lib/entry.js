...
Entry.getRange = function(origin, contexts, fn){
...
Entry.getNodes = function(origin, context, fn){


    var context_query = '(ctx:Context), ';

    if (context != "undefined" && typeof context != 'undefined') {
        context_query = '(ctx:Context{name:"' + context + '"}), c1-[:AT]->ctx, c2-[:AT]->ctx, ';
    }
