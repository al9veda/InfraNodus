...
function extractConcepts(statement, morphemes, hashnodes) {
    ...
    for (var i = 0; i<lngDetected.length; ++i) {
        if (lngDetected[i][0] == 'russian' || lngDetected[i][0] == 'macedonian' || lngDetected == 'slovak' || lngDetected == 'serbian') {
            ...
            if (lngDetected[i][0] == 'german' || lngDetected[i][0] == 'icelandic' || lngDetected[i][0] == 'italian' || lngDetected[i][0] == 'french' || lngDetected[i][0] == 'danish' || lngDetected[i][0] == 'spanish') {
...
exports.getHashtags = function(field) {
    ...
    return function(req,res,next) {
        ...
        if (res.locals.user.hashnodes != 1) {
        ...
        if (hashtags[0] == null) {
            hashtags = extractConcepts(val,res.locals.user.morphemes, res.locals.user.hashnodes);
        }
