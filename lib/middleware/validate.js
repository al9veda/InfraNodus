...
exports.required = function(statement, res){
...
exports.lengthAbove = function(statement, len, res){

        if (statement.length > len) {
           return statement;
        } else {
            res.error('a statement must have more than ' + len + ' characters');
            res.redirect('back');
        }
...
exports.stackOverflow = function(statement, res){
...
exports.getContext = function(statement, req) {
       ...
       // Contexts extracted from the statement entry form (@mentions)
        ...
        // No contexts in the body? Use the default one!
            ...
            console.log("Context @" + contexts[0] + " added automatically: " + contexts);
