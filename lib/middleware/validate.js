...
exports.getContextID = function(user_id, default_context) {
    ...
    for (var key in options.defaultstatements) {
        contexts.push(this.getContext(options.defaultstatements[key], default_context));
    }
    ...
    // Get the contexts and their IDs
