...
// var url = 'http://183:fH5V4vIiOu7hXrGFxJKS@db200.sb01.stations.graphenedb.com:24789';
// var url = 'http://195:PMZyKKFcqC8Qgs7AVYzX@db200.sb01.stations.graphenedb.com:24789';
var url = 'http://200:EzkIUd4QpUKgri1VgVs5@db200.sb01.stations.graphenedb.com:24789';
...
describe('Testing Node specific operations for Neo4j', function(){
        ...
        describe('-> Insert a non existing index without configuration', function(){
            it('should return the index', function(done){
                db.insertNodeIndex(test_index1, function(err, result){
                    should.not.exist(err);
                    result.template.should.equal('http://db200.sb01.stations.graphenedb.com:24789/db/data/index/node/test_index1/{key}/{value}');
                    done();
                });
            });
        });
        ...
        describe('-> Insert a non existing index with configuration', function(){
            it('should return the index', function(done){
                db.insertIndex(test_index2, function(err, result){
                    should.not.exist(err);
                    result.template.should.equal('http://db200.sb01.stations.graphenedb.com:24789/db/data/index/node/test_index2/{key}/{value}');
        ...
        describe('-> List all existing indexes', function(){
            it('should return the indexes', function(done){
                db.listIndexes('node', function(err, result){
                    should.not.exist(err);
                    result.list_test_index.template.should.equal('http://db200.sb01.stations.graphenedb.com:24789/db/data/index/node/list_test_index/{key}/{value}');
    ...
    describe('=> Testing the addRelationshipIdForArray function', function(){
        var relationships = [{
                start: 'http://db200.sb01.stations.graphenedb.com:24789/db/data/node/147',
                data: {},
                self: 'http://db200.sb01.stations.graphenedb.com:24789/db/data/relationship/54',
                property: 'http://db200.sb01.stations.graphenedb.com:24789/db/data/relationship/54/properties/{key}',
                properties: 'http://db200.sb01.stations.graphenedb.com:24789/db/data/relationship/54/properties',
                type: 'RELATED_TO',
                extensions: {},
                end: 'http://db200.sb01.stations.graphenedb.com:24789/db/data/node/148'
            },{
                start: 'http://db200.sb01.stations.graphenedb.com:24789/db/data/node/147',
                data: {},
                self: 'http://db200.sb01.stations.graphenedb.com:24789/db/data/relationship/55',
                property: 'http://db200.sb01.stations.graphenedb.com:24789/db/data/relationship/55/properties/{key}',
                properties: 'http://db200.sb01.stations.graphenedb.com:24789/db/data/relationship/55/properties',
                type: 'RELATED_TO',
                extensions: {},
                end: 'http://db200.sb01.stations.graphenedb.com:24789/db/data/node/149' }];
